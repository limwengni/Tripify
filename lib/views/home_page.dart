...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<NewTravelPackageModel>> fetchAdvertisementsWithPackages() async {
    ...
    return packageSnapshot.docs
        .map((doc) => NewTravelPackageModel.fromMap(doc.data()))
        .toList();
  }

  Widget _buildAdvertisementSection() {
    return FutureBuilder<List<NewTravelPackageModel>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NewTravelPackageModel> ads = snapshot.data!;
        List<NewTravelPackageModel> shuffledAds = ads..shuffle();
        List<NewTravelPackageModel> displayedAds = shuffledAds.take(5).toList();
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    NewTravelPackageModel package = displayedAds[index];
