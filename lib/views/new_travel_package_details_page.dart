...
class NewTravelPackageDetailsPage extends StatefulWidget {
  final NewTravelPackageModel
      travelPackage; // Identifier for the travel package
  final String currentUserId;
  final UserModel travelPackageUser;
  final String? adId;

  const NewTravelPackageDetailsPage(
      {Key? key,
  ...
  @override
  _NewTravelPackageDetailsPageState createState() =>
      _NewTravelPackageDetailsPageState();
}

class _NewTravelPackageDetailsPageState
    extends State<NewTravelPackageDetailsPage> {
  int quantity = 1;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                shrinkWrap: true, // Allow the ListView to adjust to its content
                physics: NeverScrollableScrollPhysics(), // Disable scrolling
                itemCount: widget.travelPackage.itinerary.length,
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    subtitle: Column(
                      children: widget.travelPackage.itinerary[index]
                              ?.map((note) {
                            return Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.fromLTRB(5, 1, 1, 5),
                                child: Row(
                                  mainAxisAlignment:
                ...
                if (widget.travelPackage.createdBy == widget.currentUserId ||
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) => AlertDialog(
                      ...
                      content: const Text(
                          'You can\'t purchase the travel package created by you!'),
                      actions: <Widget>[
                        TextButton(
              ...
              onPressed: () async {
                if (widget.travelPackage.isResale != true) {
                  ...
                  if (paymentSuccess) {
                    ...
                    if (travelPackagePurchasedBeforeMap == null || travelPackagePurchasedBeforeMap['is_refund']==true) {
                      ...
                      if (widget.adId != null && widget.adId!.isNotEmpty) {
                        ...
                        if (travelPackagePurchasedBeforeMap['ad_id'] == '' &&
                          ...
                          if (travelPackagePurchasedBeforeMap[
                                  'ticket_id_list'] !=
                              null) {
                            ...
                            ticketListUpdated = ticketIdListForPurchasedModel;
                          }
                    ...
                    if (quantityLeft == 0) {
                      await firestoreService.updateField('New_Travel_Packages',
                  ...
                  if (paymentSuccess) {
                    ...
                    await _firestoreService.updateField('New_Travel_Packages',
                        widget.travelPackage.id, 'is_available', false);
                    ...
                    if (travelPackageMapForChecking != null) {
                      NewTravelPackageModel travelPackageModelForChecking =
                          NewTravelPackageModel.fromMap(
